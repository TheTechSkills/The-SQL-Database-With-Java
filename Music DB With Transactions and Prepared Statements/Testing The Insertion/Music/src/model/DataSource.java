...
public class DataSource {
    ...
    public static final String CONNECTION_STRING ="jdbc:sqlite:G:\\Developing\\SQL Database With Java\\Programs\\Music DB With Transactions and Prepared Statements\\Music\\" + DB_NAME;
    ...
    public void insertTheSong(String songTitle, String artistName, String albumName, int trackNumber) {
        try {
            ...
            if (nrAffectedRows == 1){
                ...
                throw new SQLException("Ops! Failed to insert the song " + songTitle);
            }
            ...
            try {
                ...
                System.out.println("Ops! Couldn't rollback  " +f.getMessage());
            }
        }finally {
            try {
                ...
                System.out.println("Ops! Couldn't set AutoCommit to true" +g.getMessage());
            }
        }
    }
